...
public class MavenITmng7470ResolverTransportTest extends AbstractMavenIntegrationTestCase {
    ...
    // The Apache transport carries its new class name (ApacheTransporter instead of
    // HttpTransporter) since 4.0.0-alpha-9 and the Resolver 2.0.0 upgrade, so on this line it
    // is always the renamed one.
